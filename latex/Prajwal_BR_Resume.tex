...
{\small
\begin{itemize}
  \item \topic{MediTrustChain}\ --- Blockchain-Based Pharmaceutical Supply Chain Traceability with AI-Assisted Anomaly Detection. \textit{ICAISE 2026}, Springer Nature proceedings (forthcoming)---on-chain provenance, monitoring, and AI-assisted anomaly signals for safer supply chains. \linkboxsmall{https://link.springer.com/book/9783032235466}{Publisher listing}
...
\noindent\hfill{\small\textbf{CGPA:} 8.91/10}
