...
\begin{itemize}
  ...
  \item \keypt{Suraksha OS} \& \keypt{AuriVerify}: agentic AI compliance and multi-signal vision systems backed by \keypt{Gemini}/\keypt{FastAPI} services behind production-grade UIs.
\end{itemize}
}
\endgroup
\endgroup
...
\noindent\linkbox{https://github.com/prajwalbr0304/suraksha-agentic-compliance}{\bfseries Suraksha OS}\enspace\linkboxsmall{https://prajwalbr.netlify.app/videos/suraksha-demo.mp4}{\faPlayCircle}\quad
{\color{ResumeMuted}\textit{Next.js 16, TypeScript, Supabase (RLS/pgvector), Google ADK + Gemini agents, FastAPI; agentic compliance.}}
\begin{itemize}
...
\noindent\linkbox{https://github.com/prajwalbr0304/auriverify}{\bfseries AuriVerify}\enspace\linkboxsmall{https://prajwalbr.netlify.app/videos/AuriVerify/demo.mp4}{\faPlayCircle}\quad
{\color{ResumeMuted}\textit{Next.js 15, FastAPI, scikit-learn, Computer Vision; density + vision + streak multi-signal fusion.}}
\begin{itemize}
  \item Multi-signal gold authenticity checker that fuses density physics, vision anomaly detection, and touchstone-streak analysis to expose tungsten-cored and gold-plated fakes.
  \item Explainable GENUINE / SUSPICIOUS / LIKELY-SPURIOUS verdict with ranked reasons; optional DINOv2 vision scorer for real-image robustness.
\end{itemize}

\noindent\projtitle{Student-Management-System}{Student-Management-System}\quad
{\color{ResumeMuted}\textit{Django~5, RBAC dashboards (Admin / HOD / Staff / Student), attendance, leave, notifications.}}
\begin{itemize}
  \item Role-based portals with cohesive navigation and realistic school-operations workflows beyond basic CRUD.
\end{itemize}
}
...
{\small
\begin{itemize}
  \item \topic{Generative AI \& LLM Bootcamp}\ --- Udemy (2025): transformers, prompting, RAG, tool use (32h).
  \item \topic{Django 5 Full Stack Masterclass}\ --- Udemy (2025): DRF, auth, PostgreSQL, deployment (22h).
  \item \topic{Prompt Engineering Bootcamp}\ --- Udemy (2025): structured prompts, guardrails, evaluation (14.5h).
  \item \topic{Google Cloud \& Firebase}\ --- 2025: IAM, Firestore, Firebase Auth/Hosting, Cloud Run patterns.
  \item \topic{Amazon Bedrock \& Strands Agents SDK}\ --- AWS (2025): agentic workflows, tool calling, memory.
  \item \topic{IBM SkillsBuild --- AI Fundamentals}\ --- 2024: AI ethics, supervised learning, responsible AI.
  \item \topic{Infosys Springboard --- Full Stack Development}\ --- 2025: frontend + backend API integration.
\end{itemize}
}
